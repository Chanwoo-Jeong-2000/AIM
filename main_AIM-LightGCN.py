...
from model import AIM_LightGCN
...
print('##############################')
print('This model is AIM-LightGCN!')
...
path_name = 'result/'+args.dataset+'/AIM-LightGCN_'+args.dataset+args.path_name+'.pt'
...
if not early_stopping.early_stop:
    path_name = 'result/'+args.dataset+'/AIM-LightGCN_'+args.dataset+'_not_early_stop.pt'
